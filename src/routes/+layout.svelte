...
<div class="max-w-5xl px-4 min-h-screen mx-auto flex flex-col justify-between">
	<div>
		<Navbar let:hidden let:toggle color="none">
			<NavBrand href="/">
				<Camera variation="solid" class="w-6 h-6 dark:text-gray-400" />
				<span class="ml-2 self-center whitespace-nowrap text-2xl font-bold dark:text-gray-400">
					AI Foto
				</span>
			</NavBrand>
				...
				{#if $page.data.session}
					<div class="flex items-center space-x-6">
						...
						<button
							...
							class="text-gray-700 hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-300"
							>Logout</button
						>
					</div>
				{:else}
					<NavLi href="/login"><Button>Login</Button></NavLi>
				{/if}
			</NavUl>
		</Navbar>
	...
	<div
		class="flex justify-between flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0"
	>
