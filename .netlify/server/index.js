...
import { H as HttpError, R as Redirect, e as error, V as ValidationError, j as json } from "./chunks/index2.js";
...
async function handle_action_json_request(event, options, server) {
  const actions = server == null ? void 0 : server.actions;
  if (!actions) {
    if (server) {
...
async function render_response({
  ...
  if (page_config.csr) {
    ...
    if (page_config.ssr) {
      ...
      if (error2) {
        hydrate.push(`error: ${devalue.uneval(error2)}`);
      }
      if (options.embedded) {
...
const app_template = ({ head, body, assets: assets2, nonce }) => '<!DOCTYPE html>\n<html lang="en" class="dasrk">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + '/favicon.png" />\n		<meta name="viewport" content="width=device-width" />\n		' + head + '\n	</head>\n	<body data-sveltekit-preload-data="hover" class="bg-stone-50 dark:bg-gray-900">\n		<div style="display: contents">' + body + "</div>\n	</body>\n</html>\n";
