	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/checkout/_server.js')
			},
			{
				id: "/api/spaces",
				pattern: /^\/api\/spaces\/?$/,
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/spaces/_server.js')
			},
			{
				...
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/spaces/_id_/shots/generate/_server.js')
			},
			{
				...
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/spaces/_id_/shots/_shot_id_/_server.js')
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: () => import('../server/entries/endpoints/api/spaces/_id_/train/_server.js')
			},
			{
				id: "/callback",
				pattern: /^\/callback\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/callback/model_completed/_server.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('../server/entries/endpoints/callback/prediction_completed/_server.js')
			},
			{
				id: "/dashboard",
				pattern: /^\/dashboard\/?$/,
